...
func main() {
	...
	var cfg struct {
		...
		DB struct {
			Host     string `default:"passman:1shadow1@tcp(passman-db.cfneifgjtyib.us-east-1.rds.amazonaws.com:3306)/passman" envconfig:"MYSQL_ENDPOIN"`
			Username string `default:"passman" envconfig:"MYSQL_USERNAME"`
			Password string `default:"1shadow1" envconfig:"MYSQL_PASSWORD"`
		}
	}
