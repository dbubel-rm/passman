...
func (u *User) List(log *log.Logger, w http.ResponseWriter, r *http.Request, params map[string]string) error {
...
func (u *User) Retrieve(log *log.Logger, w http.ResponseWriter, r *http.Request, params map[string]string) error {
